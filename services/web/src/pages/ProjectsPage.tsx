    ...
    <div className="flex flex-col h-full">
      ...
      <Dialog open={showCreate} onClose={() => setShowCreate(false)}>
        ...
        <DialogContent>
          <ProjectForm
            onSubmit={(values) =>
              createProject.mutate({ name: values.name, key: values.key, description: values.description, type: values.type, templateType: values.templateType }, { onSuccess: () => setShowCreate(false) })
            }
