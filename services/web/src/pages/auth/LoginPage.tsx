...
import { useLogin, useVerify2FA, useAuthProviders } from '@/hooks/useAuth'
          ...
          <div className="mt-5">
            {!showSsoInput ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
