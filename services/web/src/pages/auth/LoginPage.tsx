          ...
          <div className="mt-5">
            {!showSsoInput ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-border rounded-lg text-sm font-medium text-foreground bg-card hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
