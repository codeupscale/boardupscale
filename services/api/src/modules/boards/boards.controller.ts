...
export class BoardsController {
  ...
  @ApiQuery({ name: 'reporterId', required: false, description: 'Filter by creator (reporter)' })
  @ApiQuery({ name: 'createdFrom', required: false, description: 'Inclusive createdAt lower bound (YYYY-MM-DD)' })
  @ApiQuery({ name: 'createdTo', required: false, description: 'Inclusive createdAt upper bound (YYYY-MM-DD)' })
